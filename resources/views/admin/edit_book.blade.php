...
<section class="container-fluid">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-8 col-lg-6 d-flex flex-column text-center justify-content-center mb-5">
            <img src="/images/books/{{$book->book_img}}" width="200" alt="" class="mx-auto mb-3">
            {!! Form::open(['action' => ['App\Http\Controllers\BooksController@update', $book->id], 'files' => true, 'method' => 'POST']) !!}
                <div class="mb-3">
